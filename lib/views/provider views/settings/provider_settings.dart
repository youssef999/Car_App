...
class ProviderSettingsPage extends StatefulWidget {
  ...
  @override
  State<ProviderSettingsPage> createState() => _SettingsPageState();
}

class _SettingsPageState extends State<ProviderSettingsPage> {
    ...
    return Scaffold(
      ...
      body: GetBuilder<SettingsController>(
          builder: (_) {
            ...
            if(controller.providerData.isNotEmpty){
                ...
                child: Column(
                  children: [
                    ...
                    _buildSettingCard(
                      ...
                      title: controller.providerData[0]['name'],
                      subtitle: controller.providerData[0]['phone'],
